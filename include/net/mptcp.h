...
/*CG add*/
//ly add start
extern int sysctl_mptcp_coding;
extern int sysctl_mptcp_testmss;
extern int sysctl_mptcp_testtcp;
extern int sysctl_mptcp_decoding;
extern int sysctl_mptcp_test;
//ly add end
...
/*mengyuan*/
//ly add
extern bool try_send_recoveries(struct sock *meta_sk,int *countfuso); ///CG add  
//ly add 
/*mengyuan*/
